package com.newpro.android.ui.transfer;
...
import com.newpro.android.ui.AboutActivity;
import com.newpro.android.ui.InstructionsActivity;
import com.newpro.android.ui.settings.SettingsActivity;
import com.newpro.android.transfer.TransferService;
import com.newpro.android.ui.explorer.ExplorerActivity;
import com.newpro.android.util.NavigatorUtils;
import com.newpro.android.util.Permissions;
...
public class TransferActivity extends AppCompatActivity
    ...
    private void finishInit() {
        ...
        ((TextView) navigationView.getHeaderView(0).findViewById(R.id.transfersubtitle)).setText(
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_recieve:
            {
                NavigatorUtils.toSystemFileChooser(this);
                break;
            }
